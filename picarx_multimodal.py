...
def multimodal(speed):
    ...
    grayscale_cp = ConsumerProducer(i.get_grayscale_value(grayin_bus.get_message("grayscale_cp")), grayin_bus, grayout_bus, delay = interpreter_delay, name = "grayscale_cp")
