...
def multimodal(speed):
    ...
    grayscale_consumer = Consumer(c.line_following(m, grayout_bus.get_message("grayscale_out")[0], speed), grayout_bus, delay = interpreter_delay, name = "grayscale_consumer")
